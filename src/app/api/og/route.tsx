  ...
  return new ImageResponse(
    (
      <div style={{
        ...
        background: "linear-gradient(135deg, #F7F6F2 0%, #101218 100%)",
        display: "flex", flexDirection: "column", padding: "70px 88px",
        color: "#F4F1EB", fontFamily: "serif", position: "relative",
      }}>
        {/* Top rule */}
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", color: "#0F6B4E", fontSize: 16, letterSpacing: 4, textTransform: "uppercase", fontWeight: 700, fontFamily: "monospace" }}>
          <span>// COMMERCIAL OPERATING SYSTEMS</span>
          <span>RIYADH · CAIRO</span>
        </div>
        <div style={{ width: 90, height: 2, background: "#0F6B4E", marginTop: 30 }} />

        {/* Headline */}
        <div style={{ display: "flex", flexDirection: "column", marginTop: 28 }}>
          <div style={{ fontSize: 84, lineHeight: 1, fontWeight: 500, letterSpacing: -1, color: "#F4F1EB" }}>Esports revenue,</div>
          <div style={{ fontSize: 84, lineHeight: 1, fontStyle: "italic", color: "#0F6B4E" }}>made defensible.</div>
        </div>
        ...
        <div style={{ marginTop: "auto", display: "flex", justifyContent: "space-between", alignItems: "flex-end", color: "#7E8088", fontSize: 18, fontFamily: "monospace" }}>
          <div style={{ display: "flex", flexDirection: "column" }}>
            <div style={{ color: "#0F6B4E", fontWeight: 700, letterSpacing: 4, fontSize: 14, textTransform: "uppercase" }}>// CURRENTLY</div>
