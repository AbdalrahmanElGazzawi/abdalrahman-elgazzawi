...
// Every photo here is unique across the whole site — none are reused in case studies.
const moments = [
  ...
  { src: "/photos/ewc-card.jpg",           alt: "Esports World Cup 2024 grand final main stage",                  caption: "EWC 2024 · grand final" },
  { src: "/photos/leap-keynote-card.jpg",  alt: "LEAP Expo keynote stage in Riyadh",                              caption: "LEAP · Riyadh keynote" },
