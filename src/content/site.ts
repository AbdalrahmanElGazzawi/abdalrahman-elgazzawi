...
export const methodologyBlurb = {
  ...
  body: "Especially useful when the problem is messy: clarifying priorities, structuring offers, aligning stakeholders, and getting results on time.",
...
export const principles = [
  ...
  { n: "03", title: "Half commercial, half ops.", body: "Closing deals and shipping deliverables are one operating system." },
];
